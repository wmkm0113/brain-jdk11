 ...
 */
@XmlType(name = "from_table", namespace = "https://nervousync.org/schemas/brain")
@XmlRootElement(name = "from_table", namespace = "https://nervousync.org/schemas/brain")
@XmlAccessorType(XmlAccessType.NONE)
public final class FromTable extends QueryFrom {
