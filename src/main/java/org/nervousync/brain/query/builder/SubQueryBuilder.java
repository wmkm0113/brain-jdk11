...
public abstract class SubQueryBuilder<P extends ParentBuilder, T extends AbstractQuery> extends AbstractBuilder<P, T> {
	...
	public static final class ScalarSubQueryBuilder<P extends ParentBuilder> extends SubQueryBuilder<P, ScalarSubQuery> {
		 ...
		 */
		public FromBuilder.FromTableBuilder<ScalarSubQueryBuilder<P>> fromTable(@Nonnull final String tableName) {
		 ...
		 * <span class="zh-CN">查询来源信息列表构建器实例对象</span>
		 */
		public FromBuilder.FromSubQueryBuilder<ScalarSubQueryBuilder<P>> fromSubQuery(@Nonnull final String aliasName) {
	...
	public static final class TableSubQueryBuilder<P extends ParentBuilder> extends SubQueryBuilder<P, TableSubQuery> {
		 ...
		 * <span class="zh-CN">查询来源信息列表构建器实例对象</span>
		 */
		public FromBuilder.FromTableBuilder<TableSubQueryBuilder<P>> fromTable(@Nonnull final String tableName) {
			return new FromBuilder.FromTableBuilder<>(this, tableName);
		}
		 ...
		 * <span class="zh-CN">查询来源信息列表构建器实例对象</span>
		 */
		public FromBuilder.FromSubQueryBuilder<TableSubQueryBuilder<P>> fromSubQuery(@Nonnull final String aliasName) {
			return new FromBuilder.FromSubQueryBuilder<>(this, aliasName);
		}
	...
	/**
	 * <h2 class="en-US">Nested table sub-query information list builder</h2>
	 * <h2 class="zh-CN">嵌套表子查询信息构建器</h2>
	 *
	 * @param <P> <span class="en-US">Parent builder generic type class</span>
	 *            <span class="zh-CN">父构建器泛型类</span>
	 * @author Steven Wee	<a href="mailto:wmkm0113@gmail.com">wmkm0113@gmail.com</a>
	 * @version $Revision: 1.0.0 $ $Date: Oct 28, 2020 11:46:08 $
	 */
	public static final class NestedTableSubQueryBuilder<P extends ParentBuilder>
			extends SubQueryBuilder<P, NestedTableSubQuery> {
		 ...
		 *                      <span class="zh-CN">父构建器实例对象</span>
		 */
		NestedTableSubQueryBuilder(final P parentBuilder) {
			super(parentBuilder);
		}
		 ...
		 * <span class="zh-CN">查询项目列表构建器实例对象</span>
		 */
		public ItemsBuilder<NestedTableSubQueryBuilder<P>> items() {
			return new ItemsBuilder<>(this, this.itemList);
		}
		 ...
		 * <span class="zh-CN">查询来源信息列表构建器实例对象</span>
		 */
		public FromBuilder.FromTableBuilder<NestedTableSubQueryBuilder<P>> fromTable(@Nonnull final String tableName) {
			return new FromBuilder.FromTableBuilder<>(this, tableName);
		}
		 ...
		 * <span class="zh-CN">查询来源信息列表构建器实例对象</span>
		 */
		public FromBuilder.FromSubQueryBuilder<NestedTableSubQueryBuilder<P>> fromSubQuery(@Nonnull final String aliasName) {
			return new FromBuilder.FromSubQueryBuilder<>(this, aliasName);
		}
		 ...
		 * <span class="zh-CN">查询关联信息列表构建器构建器实例对象</span>
		 */
		public JoinsBuilder<NestedTableSubQueryBuilder<P>> joins() {
			return new JoinsBuilder<>(this, this.queryJoins);
		}
		 ...
		 * <span class="zh-CN">查询条件组构建器实例对象</span>
		 */
		public ConditionsBuilder<NestedTableSubQueryBuilder<P>> where() {
			return new ConditionsBuilder<>(this, Boolean.FALSE, this.conditionList);
		}
		 ...
		 * <span class="zh-CN">分组数据列构建器实例对象</span>
		 */
		public SortsBuilder.GroupItemsBuilder<NestedTableSubQueryBuilder<P>> groups() {
			return new SortsBuilder.GroupItemsBuilder<>(this, this.groupByList);
		}
		 ...
		 * <span class="zh-CN">Having条件组构建器实例对象</span>
		 */
		public ConditionsBuilder<NestedTableSubQueryBuilder<P>> having() {
			return new ConditionsBuilder<>(this, Boolean.TRUE, this.havingList);
		}

		@Override
		public NestedTableSubQuery build() throws BuilderException {
			NestedTableSubQuery subQuery = new NestedTableSubQuery();
			subQuery.setQueryFrom(this.queryFrom);
			subQuery.setItemList(this.itemList);
			subQuery.setQueryJoins(this.queryJoins);
			subQuery.setConditionList(this.conditionList);
