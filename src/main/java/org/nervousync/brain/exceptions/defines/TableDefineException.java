...
public final class TableDefineException extends AbstractException {
     ...
     */
    public TableDefineException(final long errorCode, final Object... collections) {
     ...
     *                    <span class="zh-CN">用于资源信息格式化的参数</span>
     */
    public TableDefineException(final long errorCode, final Throwable cause, final Object... collections) {
