...
public abstract class JdbcDialect extends BaseDialect {
    ...
    public final Properties properties(final TrustStore trustStore, final Authentication authentication) {
        ...
        this.properties(properties, trustStore, authentication);
        return properties;
    }
    ...
    /**
     * <h3 class="en-US">Process parameter information required for connection</h3>
     * <h3 class="zh-CN">处理连接需要使用的参数信息</h3>
     *
     ...
     *                          <span class="zh-CN">身份认证信息</span>
     */
    protected void properties(final Properties properties, final TrustStore trustStore,
     ...
     *                      <span class="zh-CN">生成的SQL命令时出现错误</span>
     */
    public final GeneratedCommand insertCommand(@Nonnull final String tableName,
     ...
     *                      <span class="zh-CN">生成的SQL命令时出现错误</span>
     */
    public final GeneratedCommand queryCommand(@Nonnull final String tableName, final QueryInfo queryInfo,
                                               final boolean pagerQuery) throws SQLException {
        if (!queryInfo.getQueryJoins().isEmpty() && !this.isSupportJoin()) {
            throw new MultilingualSQLException(0x00DB00000010L);
        }
        final Map<String, String> aliasMap = new HashMap<>();
        aliasMap.put(tableName,
