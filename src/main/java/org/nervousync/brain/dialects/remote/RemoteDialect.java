...
/**
 * <h2 class="en-US">Remote database dialect implement class</h2>
 * <h2 class="zh-CN">远程数据库方言实现类</h2>
 *
 * @author Steven Wee	<a href="mailto:wmkm0113@gmail.com">wmkm0113@gmail.com</a>
 * @version $Revision: 1.0.0 $ $Date: Feb 18, 2019 10:38:52 $
 */
@Provider(name = BrainCommons.DEFAULT_REMOTE_DIALECT_NAME, titleKey = "Remote_Dialect_Title", descriptionKey = "Remote_Dialect_Description")
