...
public interface DistributeClient extends Closeable {
	 ...
	 *                   <span class="zh-CN">执行过程中出错</span>
	 */
	boolean lockRecord(@Nonnull final TableDefine tableDefine, @Nonnull final Map<String, Object> filterMap)
			throws Exception;
	 ...
	 *                   <span class="zh-CN">执行过程中出错</span>
	 */
	Map<String, Object> retrieve(@Nonnull final TableDefine tableDefine,
	 ...
	 *                   <span class="zh-CN">执行过程中出错</span>
	 */
	int update(@Nonnull final TableDefine tableDefine,
