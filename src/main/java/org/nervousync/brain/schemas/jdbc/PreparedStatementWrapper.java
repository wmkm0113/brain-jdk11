...
public final class PreparedStatementWrapper extends StatementWrapper<PreparedStatement> {
	...
	/**
	 * <h3 class="en-US">Constructor method for implementation class for the cached prepared statement</h3>
	 * <h3 class="zh-CN">可缓存的参数化查询执行器实现类的构造方法</h3>
	 *
	...
	public PreparedStatementWrapper(final String identifyKey, final long lowQueryTimeout,
		...
		super(identifyKey, lowQueryTimeout, connection, connection.createStatement(sql), sql);
	}

	/**
	 * <h3 class="en-US">Constructor method for abstract class for Neurons statement</h3>
	...
	public PreparedStatementWrapper(final String identifyKey, final long lowQueryTimeout,
			...
			throws SQLException {
		super(identifyKey, lowQueryTimeout, connection, connection.createStatement(sql, resultSetType, resultSetConcurrency), sql);
	}
	...
	public PreparedStatementWrapper(final String identifyKey, final long lowQueryTimeout,
		...
		super(identifyKey, lowQueryTimeout, connection,
				connection.createStatement(sql, resultSetType, resultSetConcurrency, resultSetHoldability), sql);
	}
	...
	public PreparedStatementWrapper(final String identifyKey, final long lowQueryTimeout,
		...
		super(identifyKey, lowQueryTimeout, connection, connection.createStatement(sql, autoGeneratedKeys), sql);
	}
	...
	public PreparedStatementWrapper(final String identifyKey, final long lowQueryTimeout,
		...
		super(identifyKey, lowQueryTimeout, connection, connection.createStatement(sql, columnIndexes), sql);
	}
	...
	public PreparedStatementWrapper(final String identifyKey, final long lowQueryTimeout,
		...
		super(identifyKey, lowQueryTimeout, connection, connection.createStatement(sql, columnNames), sql);
	}
}
