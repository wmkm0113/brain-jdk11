	...
	public void simpleAndQuery() throws Exception {
		QueryInfo queryInfo =
				new BrainQueryBuilder()
						...
						.confirm()	//	Confirm query column
						.function("MAX", Types.INTEGER)
						.aliasName("FUNC")
						.sortCode(1)
						.parameters()
						.column()
						.value("tableName", "functionColumn", Boolean.FALSE)
						.sortCode(1)
						.confirm()	//	Confirm function parameter
						.confirm()	//	Confirm function item
						.confirm()
						.calculate(CalculateCode.ADD, Types.INTEGER)
						.aliasName("TOTAL")
						.sortCode(1)
						.parameters()
						.column("tableName", "calcColumn1")
						.confirm()	//	Confirm calculate parameter
						.column("tableName", "calcColumn2")
						.confirm()	//	Confirm calculate parameter
	...
	public void simpleGroupQuery() throws Exception {
		QueryInfo queryInfo =
				new BrainQueryBuilder()
						...
						.matchQuery("subQueryTable")
						.items()
						.column("subQueryTable", "subColumn")
						.confirm()
						.confirm()
						.where()
